  ...
  describe SingleFileDataCollector do
    ...
    context "#x_pdf_data_points" do
      it "returns an array of x pdf points" do
        expected = [0, 80]
        actual = @collector.x_pdf_data_points
    ...
    context "#y_pdf_data_points" do
      it "returns an array of y pdf points" do
        expected = [17.65, 60]
        actual = @collector.y_pdf_data_points
